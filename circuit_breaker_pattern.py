...
"""
Sometimes, we don't want to retry immediately if the function failed once
We'd like to wait for a while. i.e., Retry later

e.g. 
There's a web service down for a while.
