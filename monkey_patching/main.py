...
print_header('==monkey messes up==')
def monkey_func(self, original_msg):
    print("ooh ooh eeh ah ah")

Model_YOU_CANNOT_MODIFY.analyze = monkey_func
d_model.analyze("replaced with monkey_func")
